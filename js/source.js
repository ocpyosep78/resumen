...
function makeWysiwyg (element) {
  ...
  html = '\
    <div style="border: '+style['border']+'; border-radius: 0.3em;-moz-border-radius: 0.3em; -webkit-border-radius: 0.3em;width: '+style['width']+'; overflow: auto;">\
...
function addImage(src, editor, command, coment) {
  return '<img src="js/images/actions/'+src+'" onmouseover="seleccionar(this, \'#B6BDD2\');" onmouseout="desseleccionar(this);" onmousedown="seleccionar(this, \'#8592B5\');" onclick="executeCommand(\''+editor+'\', \''+command+'\', event); desseleccionar(this);" style="border: 1px solid #F0F0EE; width; 2px; height: 20px; cursor: pointer;" alt="'+coment+'" title="'+coment+'">';
}

function addEmoticon (src, editor, coment) {
  return '<img src="js/images/emoticons/'+src+'" onmouseover="this.style.backgroundColor = \'#B6BDD2\';" onmouseout="this.style.backgroundColor = \'#F0F0EE\';" onclick="executeCommand(\''+editor+'\', \'insertimage\', event, this.src);" style="width; 18px; height: 18px; cursor: pointer;" alt="'+coment+'" title="'+coment+'">';
}

function addSeparator() {
  return '<img src="js/images/spacer.gif" style="width; 2px; height: 20px;" alt="" title="">';
}
